...
public abstract class AsyncTask<Params, Progress, Result> {
    private static final String LOG_TAG = "AsyncTaskiOS";
     ...
     */
    public AsyncTask() {
        class WorkerRunnableImpl extends WorkerRunnable<Params, Result> {
    ...
    protected final void publishProgress(Progress... values) {
        if (!isCancelled()) {
            runOnMainThread(() -> onProgressUpdate(values));
        }
    }
